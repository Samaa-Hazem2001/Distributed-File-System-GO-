...
const (
	DownloadService_DownloadReq_FullMethodName = "/AllServices.DownloadService/DownloadReq"
)
...
type DownloadServiceClient interface {
	DownloadReq(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*DownloadResponse, error)
}
...
func (c *downloadServiceClient) DownloadReq(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (*DownloadResponse, error) {
	out := new(DownloadResponse)
	err := c.cc.Invoke(ctx, DownloadService_DownloadReq_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DownloadServiceServer interface {
	DownloadReq(context.Context, *DownloadRequest) (*DownloadResponse, error)
...
func (UnimplementedDownloadServiceServer) DownloadReq(context.Context, *DownloadRequest) (*DownloadResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DownloadReq not implemented")
}
...
func _DownloadService_DownloadReq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DownloadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DownloadServiceServer).DownloadReq(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DownloadService_DownloadReq_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DownloadServiceServer).DownloadReq(ctx, req.(*DownloadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DownloadService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DownloadReq",
			Handler:    _DownloadService_DownloadReq_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "Ass/AllServices/dfs.proto",
...
const (
	DownloadFileService_DownloadFile_FullMethodName = "/AllServices.DownloadFileService/DownloadFile"
)
...
func (c *downloadFileServiceClient) DownloadFile(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (*DownloadFileResponse, error) {
	out := new(DownloadFileResponse)
	err := c.cc.Invoke(ctx, DownloadFileService_DownloadFile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDownloadFileServiceServer) DownloadFile(context.Context, *DownloadFileRequest) (*DownloadFileResponse, error) {
...
func _DownloadFileService_DownloadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DownloadFileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DownloadFileServiceServer).DownloadFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DownloadFileService_DownloadFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DownloadFileServiceServer).DownloadFile(ctx, req.(*DownloadFileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DownloadFileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "AllServices.DownloadFileService",
	HandlerType: (*DownloadFileServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DownloadFile",
			Handler:    _DownloadFileService_DownloadFile_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "Ass/AllServices/dfs.proto",
...
const (
	UploadFileService_UploadFile_FullMethodName = "/AllServices.UploadFileService/UploadFile"
)
...
func (c *uploadFileServiceClient) UploadFile(ctx context.Context, in *UploadFileRequest, opts ...grpc.CallOption) (*UploadFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, UploadFileService_UploadFile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var UploadFileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "AllServices.UploadFileService",
...
type DoneUpServiceClient interface {
	DoneUp(ctx context.Context, in *DoneUptRequest, opts ...grpc.CallOption) (*DoneUpResponse, error)
}
...
func (c *doneUpServiceClient) DoneUp(ctx context.Context, in *DoneUptRequest, opts ...grpc.CallOption) (*DoneUpResponse, error) {
...
type DoneUpServiceServer interface {
	DoneUp(context.Context, *DoneUptRequest) (*DoneUpResponse, error)
...
func (UnimplementedDoneUpServiceServer) DoneUp(context.Context, *DoneUptRequest) (*DoneUpResponse, error) {
...
func _DoneUpService_DoneUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DoneUpServiceServer).DoneUp(ctx, req.(*DoneUptRequest))
	}
	return interceptor(ctx, in, info, handler)
}
