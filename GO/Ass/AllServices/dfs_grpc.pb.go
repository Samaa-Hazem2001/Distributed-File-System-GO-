...
const (
	...
	KeepersService_KeeperDoneDown_FullMethodName  = "/AllServices.KeepersService/KeeperDoneDown"
...
type KeepersServiceClient interface {
	...
	KeeperDoneDown(ctx context.Context, in *KeeperDoneDownRequest, opts ...grpc.CallOption) (*KeeperDoneDownResponse, error)
...
func (c *keepersServiceClient) KeeperDoneDown(ctx context.Context, in *KeeperDoneDownRequest, opts ...grpc.CallOption) (*KeeperDoneDownResponse, error) {
	out := new(KeeperDoneDownResponse)
	err := c.cc.Invoke(ctx, KeepersService_KeeperDoneDown_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KeepersServiceServer interface {
	...
	KeeperDoneDown(context.Context, *KeeperDoneDownRequest) (*KeeperDoneDownResponse, error)
...
func (UnimplementedKeepersServiceServer) KeeperDoneDown(context.Context, *KeeperDoneDownRequest) (*KeeperDoneDownResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method KeeperDoneDown not implemented")
}
...
func _KeepersService_KeeperDoneDown_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KeeperDoneDownRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeepersServiceServer).KeeperDoneDown(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeepersService_KeeperDoneDown_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeepersServiceServer).KeeperDoneDown(ctx, req.(*KeeperDoneDownRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KeepersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "KeeperDoneDown",
			Handler:    _KeepersService_KeeperDoneDown_Handler,
		},
		{
